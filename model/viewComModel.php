<?php // prepare select for the blog page (it's here for title of page)
...
?>
    ...
    if (!empty($_SESSION['pseudo'])) {
      echo "<div class='colorbillet col-12 col-md-8 col-lg-6 mx-auto blogcreate mt-2'>
     ...
     // add some commentary
      echo '<form class="col-12 col-md-8 col-lg-6 mx-auto m-0 p-0 pt-2 text-right" action="verifcom.php?blog=' . $_GET["blog"] . '&amp;pseudo=' . $_SESSION["pseudo"] . '" method="post">
      <textarea class="col-12" name="commentary" rows="4" cols="80" placeholder="Répondre à: ' . $pseudo . '"></textarea>
